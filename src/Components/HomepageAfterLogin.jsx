...
function HomepageAfter() {
  return (
    <>
      ...
      <h5 style={{padding: '20px', marginLeft: '50px'}}>Recent Videos</h5>
      <Movies />
      <h5 style={{padding: '20px', marginLeft: '50px'}}>Popular Videos</h5>
      <Popular />
      <h5 style={{padding: '20px', marginLeft: '50px'}}>Shorts</h5>
      <Shots />
